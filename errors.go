// Package errors is a slightly modified copy of the upspin.io/errors package
...
// Str recreates the errors.New functionality of the standard Go errors package
